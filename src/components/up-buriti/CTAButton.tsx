...
import { WHATSAPP_MESSAGE_URL } from "@/lib/contact";
...
export const CTAButton = ({
  ...
  const variants = {
    whatsapp:
      "bg-whatsapp text-whatsapp-foreground hover:brightness-110 shadow-cta",
    primary:
      "bg-gradient-primary text-primary-foreground hover:brightness-110 shadow-elegant",
    outline:
      "bg-transparent text-foreground border-2 border-foreground/15 hover:bg-foreground/5",
  };
  const sizes = {

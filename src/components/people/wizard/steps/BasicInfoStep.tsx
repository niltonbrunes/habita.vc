...
export function BasicInfoStep({ data, onChange }: Props) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      <div>
        <h2 className="text-2xl font-black text-primary mb-1">Dados Básicos</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className={`flex items-center justify-center gap-3 p-4 rounded-2xl border-2 font-bold transition-all ${
            !isPJ ? 'border-primary bg-primary/5 text-primary' : 'border-border bg-white text-muted-foreground hover:border-primary/30'
          }`}
        >
